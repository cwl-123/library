...
import com.library.library.controller.MessageController;
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                while (true) {
                    ...
                    String tim=(time.format(form).toString());

                    if(tim.charAt(0)=='2'&&tim.charAt(1)=='2'&&tim.charAt(3)=='0'
                            &&tim.charAt(4)=='0'&&tim.charAt(6)=='0'&&tim.charAt(7)=='0')
                    {
                        sendPost("http://localhost:8080/v1/msg/clean","");
                    }
